import { LocaleNamespaces } from "./LocaleNamespaces"
...
export const Locale_EN_GB: Map<string, string> = new Map<string, string>([
    ...
    [LocaleNamespaces.cmd_permissions, "Player does not have sufficient permissions to use this command"],
    [LocaleNamespaces.cmd_alias_debug, "test"],
